...
function install()
{
    ...
    wget --no-check-certificate https://gitee.com/siryle1213/dsm_javdb_patch/raw/master/dsm_javbus_all_patch.tar -O dsm_javbus_all_patch.tar;
    tar -xvf dsm_javbus_all_patch.tar

    cp -rfa ./dsm_javbus_all_patch/syno_themoviedb /var/packages/VideoStation/target/plugins/;
    cp -rfa ./dsm_javbus_all_patch/syno_synovideodb /var/packages/VideoStation/target/plugins/;
    cp -rfa ./dsm_javbus_all_patch/ui /var/packages/VideoStation/target/;
    cp -rfa ./dsm_javbus_all_patch/syno_thetvdb /var/packages/VideoStation/target/plugins/;
    cp -rfa ./dsm_javbus_all_patch/syno_file_assets /var/packages/VideoStation/target/plugins/;
